...
if command -v ollama >/dev/null 2>&1; then
  ...
  echo "   (Ollama CLI ya fue desinstalado en paso 2)"
else
...
# Eliminar aussi el backup del launcher si existe
if [ -f "${DESKTOP_LAUNCHER}.bak-"* ]; then
  rm -f ${DESKTOP_LAUNCHER}.bak-* && echo "   Backups del launcher eliminados."
fi
...
echo "========================================"
echo ""
echo "Lo que se mantubo:"
echo "- Homebrew"
echo "- OpenCode (si no estaba via Homebrew)"
echo "- Configuracion y auth (si elegiste mantenerlos)"
echo ""
